...
const Pagination = ({currentPage, totalPages, changePage}: {
  ...
  return (
    <div className="pagination">
        <button type="button" disabled={currentPage <= 1 ? true : false} onClick={() => changePage(-1)}>
        ...
        <button type="button" disabled={currentPage >= totalPages ? true : false} onClick={() => changePage(+1)}>
          <svg width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
